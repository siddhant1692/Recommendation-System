...
tfidf_matrix = tfidf.fit_transform(book.Publisher)   #Transform a count matrix to a normalized tf or tf-idf representation
...
get_book_recommendations("Classical Mythology",topN=10)
