...
import pandas as pd
#import Dataset 
book = pd.read_csv("file:\\D:\\Data Science\\Excelr\\Assignments\\Assignment\\Recommendation System\\books1.csv",dtype=str)
book.shape #shape
book.columns
book.ratings#ratings column
...
# empty string
book["ratings"].isnull().sum() 
book["ratings"] = book["ratings"].fillna(" ")

# Preparing the Tfidf matrix by fitting and transforming

tfidf_matrix = tfidf.fit_transform(book.ratings)   #Transform a count matrix to a normalized tf or tf-idf representation
